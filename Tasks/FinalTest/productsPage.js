                ...
                products += `<li id="${uniqueId}"
                        ...
                        <div class="p-4 space-y-2 text-center">
                            ...
                            <div class="flex gap-2 items-center justify-center">
                                <div class="bg-green-700 items-center gap-1 text-white pl-2 flex py-0.5 rounded-sm text-sm relative w-16"><svg class=" h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
